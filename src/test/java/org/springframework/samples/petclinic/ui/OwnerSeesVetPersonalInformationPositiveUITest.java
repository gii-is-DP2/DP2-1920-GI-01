...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
 class OwnerSeesVetPersonalInformationPositiveUITest {
	...
	public static void loginAsOwner(final WebDriver driver, final int port) {
	...
	@Test
	 void testOwnerSeesVetPersonalInformation() throws Exception {
		...
		OwnerSeesVetPersonalInformationPositiveUITest.loginAsOwner(this.driver, this.port);

		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[3]/a/span[2]")).click();
		this.driver.findElement(By.xpath("//a[contains(text(),'James Carter')]")).click();
