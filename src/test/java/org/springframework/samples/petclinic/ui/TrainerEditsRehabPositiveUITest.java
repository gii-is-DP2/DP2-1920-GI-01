...
public class TrainerEditsRehabPositiveUITest {
	  ...
	  public void testTrainerEditingRehab() {
		  ...
		  driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[2]/a/span[2]")).click();
		    ...
		    driver.findElement(By.id("description")).click();
		    driver.findElement(By.id("description")).clear();
		    driver.findElement(By.id("description")).sendKeys("test edit");
		    driver.findElement(By.xpath("//button[@type='submit']")).click();
		    driver.findElement(By.xpath("//td[3]")).click();
		    assertEquals("test edit", driver.findElement(By.xpath("//td[3]")).getText());
