...
public class VetSeesPetsVisitsNegativeUITest {
  ...
  public void testTrainerAddsRehab () throws Exception {
	  ...
	  VetTryingToSeePetsVisitsWithoutLogingIn(driver, port);
  ...
  public void VetTryingToSeePetsVisitsWithoutLogingIn(WebDriver driver, int port) throws Exception {
