...
public class VetAddsPrescriptionNegativeUITest {
  ...
  @Test
  public void testUS007Negative() throws Exception {
    ...
    driver.findElement(By.id("dose")).sendKeys("prueba");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("is required", driver.findElement(By.xpath("//form[@id='prescription']/div/div[2]/div/div/span[2]")).getText());
  }
