...
public class VetAddsPrescriptionPositiveUITest {
  ...
  public void testUS007Positive() throws Exception {
    ...
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("test dose", driver.findElement(By.xpath("//table[@id='prescriptionsTable']/tbody/tr[2]/td[2]")).getText());
    assertEquals("Cat medicine", driver.findElement(By.xpath("(//a[contains(text(),'Cat medicine')])[2]")).getText());
  }
