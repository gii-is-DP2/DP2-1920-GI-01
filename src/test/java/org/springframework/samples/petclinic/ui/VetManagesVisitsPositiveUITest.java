...
public class VetManagesVisitsPositiveUITest {
	...
	public void testVetShouldAddNewIntervention() throws Exception {
		...
		this.driver.findElement(By.id("date")).sendKeys("2020/05/20");
		this.driver.findElement(By.id("description")).click();
		this.driver.findElement(By.id("description")).clear();
		this.driver.findElement(By.id("description")).sendKeys("Vet adds intervention positive UI Test");
