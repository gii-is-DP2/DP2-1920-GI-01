...
class OwnerWantsToSeeTrainersPersonalInfo extends Simulation {
...
TrainerUnsuccessful.trainerunsuccessful
	...
	setUp(OwnerSeesTrainersPersonalInfo.inject(atOnceUsers(1)),
	      OwnerCantSeeTrainersPersonalInfo.inject(atOnceUsers(1))
