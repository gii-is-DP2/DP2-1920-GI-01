...
class PetAdoptionDiagnosis extends Simulation {
	...
	setUp(petAdoptionPositiveScn.inject(rampUsers(1600) during (100 seconds)),
          petAdoptionNegativeScn.inject(rampUsers(1600) during (100 seconds)))
