...
class MedicalRecordUpdate extends Simulation {
	...
	setUp(medicalRecordUpdatePositiveScn.inject(rampUsers(250) during (100 seconds)) , medicalRecordUpdateNegativeScn.inject(rampUsers(250) during (100 seconds))).protocols(httpProtocol)
