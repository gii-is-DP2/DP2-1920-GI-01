...
class TrainerSeesPetVisitsDiagnosis extends Simulation {
  ...
  val trainerSeesPetVisitsNegativeScn = scenario("TrainerSeesPetVisitsNegative").exec(Home.home,
	...
	setUp(trainerSeesPetVisitsPositiveScn.inject(rampUsers(3500) during (100 seconds)),
          trainerSeesPetVisitsNegativeScn.inject(rampUsers(3500) during (100 seconds))
